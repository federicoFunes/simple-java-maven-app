job('Java Maven App DSL 3') {
    ...
    scm {
        git('https://github.com/federicoFunes/simple-java-maven-app.git', 'master') { node ->
            node / gitConfigName('federicoFunes')
            node / gitConfigEmail('federico.funes@holon.com.ar')
        }
    }
    triggers {
    	githubPush()
